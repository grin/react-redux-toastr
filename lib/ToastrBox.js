...
var ToastrBox = function (_Component) {
  ...
  ToastrBox.prototype.renderContent = function renderContent() {
    if (this.props.item.options.component) {
      return _react2.default.createElement(
        'div',
        { className: 'toastrContent' },
        _react2.default.createElement(this.props.item.options.component, this.props.item)
      );
    } else {
      return _react2.default.createElement(
        'div',
  ...
  ToastrBox.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      'div',
      {
        ...
        className: (0, _classnames2.default)('toastr', 'animated', this.props.item.type),
